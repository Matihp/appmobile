...
import org.appandroidmc.entity.DocumentoAlmacenado;
import org.appandroidmc.repository.DocAlmacenadoRepository;
...
@Service
@Transactional
public class DocAlmacenadoService {
    private DocAlmacenadoRepository repo;
    private FileStorageService storageService;

    public DocAlmacenadoService(DocAlmacenadoRepository repo, FileStorageService storageService) {
        this.repo = repo;
